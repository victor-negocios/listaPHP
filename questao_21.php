<?php
// Questão 21: Quais são os três menores valores de despesa?
...
foreach($transacoes as $transacao){
  if($transacao['tipoDeTransacao']=="Despesa"){
    array_push($menores, $transacao['valor']);
  }
}

sort($menores);
echo "Os três menores valores de transações de despesas são: <br>";
