<?php
// Questão 7: Qual o menor valor de despesa e qual pessoa o realizou?
...
foreach($transacoes as $transacao){
  if($transacao['tipoDeTransacao'] == "Despesa"){
    if($menorDespesa == 0){
      $menorDespesa = $transacao['valor'];
    }
    if($transacao['valor'] < $menorDespesa){
      $menorDespesa = $transacao['valor'];
      $responsavel = $transacao['nome'];
    }
  }
}

echo "<pre>";
print_r("Menor despesa: $menorDespesa, Realizada por: $responsavel");
