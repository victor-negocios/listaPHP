<?php
// Questão 19: Quais transações possuem valores entre 100 e 300?
...
foreach($transacoes as $transacao){
  if($transacao['valor']>=100 && $transacao['valor'] <= 300){
    $transacoesEntre += 1;
  }
}

echo "Transações que possuem valores entre 100 e 300 : $transacoesEntre";
