<?php
// Questão 3: Quantas transações de cada tipo (Receita e Despesa) existem no array?
...
foreach ($transacoes as $transacao){
  if($transacao['tipoDeTransacao'] == "Despesa"){
    $totalDespesas += 1;
  }elseif($transacao['tipoDeTransacao'] == "Receita"){
    $totalReceitas += 1;
  }
}
echo "<hr>";
echo "Total de transações de Despesa: $totalDespesas";
echo "<br>";
echo "Total de transações de Receita: $totalReceitas";
