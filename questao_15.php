<?php
// Questão 15: Liste todas as pessoas que realizaram transações do tipo 'Despesa'.
...
echo "Pessoas que realizaram transações do tipo 'Despesa': <br><br>";
foreach($transacoes as $transacao){
  if($transacao['tipoDeTransacao'] == "Despesa"){
    echo "$transacao[nome] <br>";
  }
}
?>
