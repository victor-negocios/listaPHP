<?php
// Questão 4: Qual a média dos valores das receitas?
...
foreach ($transacoes as $transacao){
  if($transacao['tipoDeTransacao'] == "Receita"){
    $valorReceitas += $transacao['valor'];
  }
  if($transacao['tipoDeTransacao'] == "Receita"){
    $totalReceitas += 1;
  }
...
$valorReceitas = $valorReceitas/$totalReceitas;

echo "Média dos valores das transações de receita: $valorReceitas";
