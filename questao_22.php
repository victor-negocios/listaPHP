<?php
// Questão 22: Quantas transações possuem uma descrição que começa com a letra 'S'?
...
foreach($transacoes as $transacao){
  if(str_starts_with($transacao['descricao'], "S")){
    $comecaComS += 1;
  }
}

echo "Transações que possuem no início da sua descrição 'S': $comecaComS";
