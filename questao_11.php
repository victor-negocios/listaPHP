<?php
// Questão 11: Liste todas as pessoas que realizaram uma despesa com valor superior a 100.
...
foreach($transacoes as $transacao){
  if($transacao['tipoDeTransacao']=="Despesa" && $transacao['valor']>100){
    array_push($pessoas, $transacao['nome']);
  }
}
