<?php
// Questão 8: Quantas transações foram realizadas por pessoas do gênero 'feminino' e 'masculino'?
...
$transacoesMasculino = 0;
$transacoesFeminino = 0;

foreach($transacoes as $transacao){
  if($transacao['genero'] == "feminino"){
    $transacoesFeminino += 1;
  }
  else{
    $transacoesMasculino += 1;
  }
}

echo "Transações Masculinas: $transacoesMasculino <br> Transações Femininas: $transacoesFeminino";
