<?php
// Questão 14: Qual é a diferença entre o total de receitas e o total de despesas?
...
echo "Receitas: $receitas <br>";

$total = $receitas - $despesas;
echo "<hr>Diferença dos valores das receitas pelas despesas: $total";
