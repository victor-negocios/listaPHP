<?php
// Questão 17: Quantas transações possuem a descrição 'Aluguel'?
...
foreach($transacoes as $transacao){
  if(str_contains($transacao['descricao'], "Aluguel",)){
    $qtdAlugueis += 1;
  }
}

echo "Transações com a descrição 'Aluguel': <br> $qtdAlugueis";
