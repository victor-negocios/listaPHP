<?php
// Questão 18: Qual o valor total de receitas realizadas por pessoas do gênero 'masculino'?
...
foreach($transacoes as $transacao){
  if($transacao['genero'] == "masculino" && $transacao['tipoDeTransacao'] == "Receita"){
    $qtdReceitasM += 1;
  }
}

echo "Quantidade de Transações de Receitas do gênero 'Masculino': $qtdReceitasM";
